        ...
        <div class="flex items-start justify-between">
            <div class="relative hidden h-screen my-4 ml-4 shadow-lg lg:block w-80">
                <div class="h-full bg-white rounded-2xl dark:bg-gray-700">
                    ...
                    <nav class="mt-6">
                        <div>
                            <a href="{{ route('klinik.dashboard') }}" class="flex items-center justify-start w-full p-4 my-2 font-thin text-gray-500 uppercase transition-colors duration-200 dark:text-gray-200 hover:text-blue-500">
                            ...
                            <a href="{{ route('klinik.clientList') }}" class="flex items-center justify-start w-full p-4 my-2 font-thin text-blue-500 uppercase transition-colors duration-200 border-r-4 border-blue-500 bg-gradient-to-r from-white to-blue-100 dark:from-gray-700 dark:to-gray-800" href="#">
                                <span class="text-left">
            ...
            <div class="flex flex-col w-full pl-0 md:p-4 md:space-y-4">
                ...
                <h3 class="text-white">Login Klinik Name : {{ Auth::guard('klinik')->user()->name }}</h3>
                <h3 class="text-white">Login Klinik Email : {{ Auth::guard('klinik')->user()->email }}</h3>
                        ...
                        <div class="relative flex items-center w-full pl-1 lg:max-w-68 sm:pr-2 sm:ml-0">
                            <div class="container relative left-0 z-50 flex w-3/4 h-auto h-full">
                                ...
                                <div class="relative flex items-center justify-end w-1/4 p-1 ml-5 mr-4 sm:mr-0 sm:right-auto" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
                                    ...
                                    <a href="{{ route('klinik.logout') }}" method="get" class="block block px-4 py-2 text-md text-gray-700 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-100 dark:hover:text-white dark:hover:bg-gray-600" role="menuitem">
                                            ...
                                            <tr>
                                                ...
                                                <td class="px-5 py-5 text-sm bg-white border-b border-gray-200">
                                                    <button type="button" class="py-2 px-4 flex justify-center items-center  bg-red-600 hover:bg-red-700 focus:ring-red-500 focus:ring-offset-red-200 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg  ">
                                                        <a href='delete/{{ $Publiks->id }}'>Delete</a>
                                                    </button>
                                                </td>
                                            </tr>
                                        @endforeach
