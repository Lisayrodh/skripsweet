        ...
        <div class="container">
          ...
          <div class="section-title">
            <span class="justify-center text-sm text-center text-gray-500 flex-items-center dark:text-gray-400">
                ...
                <a href="{{ route('login_from') }}" target="_blank" class="text-sm text-blue-500 underline hover:text-blue-700">
                    Sign in
                </a>
            </span>
          </div>

          <form action="{{ route('klinik.register.create') }}" method="POST" class="php-email-form">
            @csrf
            <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-md-4 form-group mt-3 ">
                <input type="password" name="password" class="form-control datepicker"  placeholder="Confirm Password" data-rule="minlen:4" data-msg="Please enter at least 4 chars">
                <div class="validate"></div>
              </div>
...
@endsection
        ...
        {{-- <form action="{{ route('klinik.register.create') }}" method="POST">
            @csrf
