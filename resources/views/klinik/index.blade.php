        ...
        <div class="relative hidden h-screen my-4 ml-4 shadow-lg lg:block w-80">
            <div class="h-full bg-white rounded-2xl dark:bg-gray-700">
                <div class="flex items-center justify-center pt-6">
                    ...
                    <nav class="mt-6">
                        <div>
                            <a href="{{ route('klinik.dashboard') }}" class="flex items-center justify-start w-full p-4 my-2 font-thin text-blue-500 uppercase transition-colors duration-200 border-r-4 border-blue-500 bg-gradient-to-r from-white to-blue-100 dark:from-gray-700 dark:to-gray-800" href="#">
                            ...
                            <a href="{{ route('klinik.clientList') }}" class="flex items-center justify-start w-full p-4 my-2 font-thin text-gray-500 uppercase transition-colors duration-200 dark:text-gray-200 hover:text-blue-500">
                                <span class="text-left">
...
{{-- <div class="flex flex-col max-w-md px-4 py-8 bg-white rounded-lg shadow dark:bg-gray-700 sm:px-6 md:px-8 lg:px-10">
    ...
    <div class="mt-8">
        <form action="{{ route('klinik.newUser') }}" method="POST">
            @csrf
